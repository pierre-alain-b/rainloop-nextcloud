...
<div class="section">
	<form id="mail-rainloop-personal-form" action="#" method="post">
		...
		<fieldset class="personalblock">
			...
			<p>
				<?php echo ($l->t('Enter an email and password to auto-login to RainLoop. <b>Please note</b> that this feature <a href=https://github.com/pierre-alain-b/rainloop-nextcloud/issues/87 style=text-decoration:underline target=_blank>may have some</a> <a href=https://github.com/RainLoop/rainloop-webmail/issues/1082 style=text-decoration:underline target=_blank>security considerations</a>.')); ?>
			</p>
			<p>
