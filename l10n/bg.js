OC.L10N.register(
    ...
    "RainLoop (deprecated, consider Snappymail)" : "RainLoop (отпаднал, вземете предвид Snappymail)",
    "RainLoop Webmail (deprecated, consider Snappymail)" : "RainLoop Webmail (отпаднал, вземете предвид Snappymail)",
    "Rainloop is not maintained anymore. Consider a switch to Snappymail which is an actively-maintained fork of Rainloop. After enabling in Nextcloud, go to Nextcloud admin panel, \"Additionnal settings\" and you will see a \"Rainloop webmail\" section. There, click on the link to go to the Rainloop admin panel. The default user/password is admin/12345. This version is based on Rainloop 1.16.0 (2021-05)." : "Rainloop вече не се поддържа. Обмислете възможността за преминаване към приложението Snappymail, което е активно поддържано разклонение на Rainloop. След като го активирате в Nextcloud, отидете в административния панел на Nextcloud, \"Допълнителни настройки\" и ще видите раздел \"Rainloop webmail\". Там щракнете върху връзката, за да отидете в административния панел на Rainloop. Потребителят/паролата по подразбиране е admin/12345. Тази версия е базирана на Rainloop 1.16.0 (2021-05).",
