OC.L10N.register(
    ...
    "RainLoop (deprecated, consider Snappymail)" : "RainLoop (przestarzały, rozważ Snappymail)",
    "RainLoop Webmail (deprecated, consider Snappymail)" : "RainLoop Webmail (przestarzały, rozważ Snappymail)",
    "Rainloop is not maintained anymore. Consider a switch to Snappymail which is an actively-maintained fork of Rainloop. After enabling in Nextcloud, go to Nextcloud admin panel, \"Additionnal settings\" and you will see a \"Rainloop webmail\" section. There, click on the link to go to the Rainloop admin panel. The default user/password is admin/12345. This version is based on Rainloop 1.16.0 (2021-05)." : "Rainloop nie jest już utrzymywany. Rozważ przejście na Snappymail, który jest aktywnie utrzymywanym widelcem Rainloop. Po włączeniu w Nextcloud, przejdź do panelu administracyjnego Nextcloud, \"Dodatkowe ustawienia\", a zobaczysz sekcję \"Rainloop webmail\". Tam kliknij link, aby przejść do panelu administracyjnego Rainloop. Domyślny użytkownik/hasło to admin/12345. Ta wersja jest oparta na Rainloop 1.16.0 (2021-05).",
