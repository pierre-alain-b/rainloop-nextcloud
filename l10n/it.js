OC.L10N.register(
    ...
    "Simple, modern and fast web-based email client. After enabling in Nextcloud, go to Nextcloud admin panel, \"Additionnal settings\" and you will see a \"Rainloop webmail\" section. There, click on the link to go to the Rainloop admin panel. The default user/password is admin/12345. This version is based on Rainloop 1.14.0 (2020-01)." : "Client email basato su tecnologie web semplice, moderno e veloce. Dopo l'attivazione in Nextcloud, vai nel pannello di amministrazione di Nextcloud, \"Impostazioni aggiuntive\" e vedrai una sezione \"Webmail Rainloop\". Lì, fai clic sul collegamento per andare al pannello di amministrazione di Rainloop. L'utente/password predefinito è admin/12345. Questa versione è basata su Rainloop 1.14.0 (2020-01).",
    ...
    "Enter an email and password to auto-login to RainLoop." : "Digita un indirizzo email e una password per l'accesso automatico a RainLoop.",
    "Please note" : "Nota",
    "that this feature" : "che questa funzionalità",
