OC.L10N.register(
    ...
    "Simple, modern and fast web-based email client. After enabling in Nextcloud, go to Nextcloud admin panel, \"Additionnal settings\" and you will see a \"Rainloop webmail\" section. There, click on the link to go to the Rainloop admin panel. The default user/password is admin/12345. This version is based on Rainloop 1.14.0 (2020-01)." : "Client de correu electrònic senzill, modern i ràpid basat en la web. Després d'habilitar-lo en el Nextcloud, aneu al tauler d'administració del Nextcloud, «Paràmetres addicionals» i veureu una secció anomenada «Correu web RainLoop» Allà, feu clic en l'enllaç per anar al tauler d'administració del RainLoop. L'usuari i la contrasenya per defecte són admin/12345. Aquesta versió està basada en el RainLoop 1.14.0 (2020-01).",
    ...
    "Enter an email and password to auto-login to RainLoop. <b>Please note</b> that this feature %s %s." : "Introduïu una adreça electrònica i una contrasenya per iniciar la sessió automàticament en el RainLoop. <b>Tingueu en compte</b> que aquesta característica %s %s.",
