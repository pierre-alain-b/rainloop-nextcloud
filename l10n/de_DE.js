OC.L10N.register(
    ...
    "RainLoop (deprecated, consider Snappymail)" : "RainLoop (veraltet, erwägen Sie Snappymail zu verwenden)",
    "RainLoop Webmail (deprecated, consider Snappymail)" : "RainLoop Webmail (veraltet, erwägen Sie Snappymail zu verwenden)",
    "Rainloop is not maintained anymore. Consider a switch to Snappymail which is an actively-maintained fork of Rainloop. After enabling in Nextcloud, go to Nextcloud admin panel, \"Additionnal settings\" and you will see a \"Rainloop webmail\" section. There, click on the link to go to the Rainloop admin panel. The default user/password is admin/12345. This version is based on Rainloop 1.16.0 (2021-05)." : "Rainloop wird nicht mehr gepflegt. Erwägen Sie einen Wechsel zu Snappymail, einem aktiv gepflegten Fork von Rainloop. Gehen Sie nach der Aktivierung in Nextcloud zum Nextcloud-Adminbereich, „Zusätzliche Einstellungen“ und Sie sehen einen Abschnitt „Rainloop-Webmail“. Klicken Sie dort auf den Link, um zum Rainloop-Adminbereich zu gelangen. Der Standardbenutzer/das Standardpasswort ist admin/12345. Diese Version basiert auf Rainloop 1.16.0 (2021-05).",
