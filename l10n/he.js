OC.L10N.register(
    ...
    "Simple, modern and fast web-based email client. After enabling in Nextcloud, go to Nextcloud admin panel, \"Additionnal settings\" and you will see a \"Rainloop webmail\" section. There, click on the link to go to the Rainloop admin panel. The default user/password is admin/12345. This version is based on Rainloop 1.14.0 (2020-01)." : "לקוח דוא״ל פשוט, מודרני ומהיר מבוסס אתר. לאחר ההפעלה ב־Nextcloud, יש לגשת אל לוח הניהול של Nextcloud, „הגדרות נוספות” ושם יופיע הסעיף „דוא״ל דפדפן RainLoop”. שם עליך ללחוץ על הקישור כדי להגיע ללוח הניהול של RainLoop. שם המשתמש/ססמה כבררת מחדל הם admin‏/12345. גרסה זו מבוססת על Rainloop 1.14.0‏ (2020-01)‎.",
