OC.L10N.register(
    ...
    "Simple, modern and fast web-based email client. After enabling in Nextcloud, go to Nextcloud admin panel, \"Additionnal settings\" and you will see a \"Rainloop webmail\" section. There, click on the link to go to the Rainloop admin panel. The default user/password is admin/12345. This version is based on Rainloop 1.14.0 (2020-01)." : "Einfacher, moderner und schneller webbasierter E-Mail-Client. Nach der Aktivierung in Nextcloud, sehen Sie im Nextcloud-Administrationsbereich unter \"Zusätzliche Einstellungen\" einen Abschnitt nit Namen \"Rainloop Webmail\". Klicken Sie dort auf den Link, um zum Rainloop-Verwaltungsbereich zu gelangen. Der Standardbenutzer/Passwort ist admin/12345. Diese Version basiert auf Rainloop 1.14.0 (2020-01).",
    "Go to RainLoop Webmail admin panel" : "Gehen Sie zum Administrator-Bereich von RainLoop Webmail ",
    "Users will login manually, or define credentials in their personal settings for automatic logins." : "Benutzer melden sich manuell an oder definieren in ihren persönlichen Einstellungen Zugangsdaten für die automatische Anmeldung.",
    ...
    "Enter an email and password to auto-login to RainLoop." : "E-Mail-Adresse und Passwort eingeben für die automatische Anmeldung bei RainLoop.",
    "Please note" : "Bitte beachten",
    "that this feature" : "dass diese Funktion",
