OC.L10N.register(
    ...
    "RainLoop (deprecated, consider Snappymail)" : "Rainloop (descontinuado, considere usar Snappymail)",
    "RainLoop Webmail (deprecated, consider Snappymail)" : "Webmail Rainloop (descontinuado, considere usar Snappymail)",
    "Rainloop is not maintained anymore. Consider a switch to Snappymail which is an actively-maintained fork of Rainloop. After enabling in Nextcloud, go to Nextcloud admin panel, \"Additionnal settings\" and you will see a \"Rainloop webmail\" section. There, click on the link to go to the Rainloop admin panel. The default user/password is admin/12345. This version is based on Rainloop 1.16.0 (2021-05)." : "Rainloop ya no es mantenido. Considere cambiar hacia Snappymail que es un fork activamente mantenido de Rainloop. Luego de habilitarlo en Nextcloud, vaya al panel de administración de Nextcloud, en \"Configuraciones adicionales\" verá una sección \"Rainloop Webmail\". Allí, haga click para ir al panel de administración de Rainlopp. El usuario/contraseña por defecto es admin/12345. Esta versión está basada en Rainloop 1.16.0 (2021-05).",
